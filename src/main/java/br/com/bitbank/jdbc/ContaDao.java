...
public class ContaDao {
	...
	public Conta porAgenciaConta(String agencia, String conta) {
		return manager
				.createQuery("select c from Conta c where c.agencia = :agencia and c.nConta = :conta", Conta.class)
				.setParameter("agencia", agencia).setParameter("conta", conta).getSingleResult();
	}
}
